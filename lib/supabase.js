...
export const calculerSoldeBancaire = async () => {
  ...
  // 5. Calculs finaux
  const soldeBrut = initial + totalPaiements + totalGaranties - totalDepenses
  const soldeNet = soldeBrut - totalGaranties
