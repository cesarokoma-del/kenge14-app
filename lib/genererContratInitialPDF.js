...
export function genererContratInitialPDF(contrat = {}) {
  ...
  ajouterArticle(
    ...
    `Le Bailleur donne en location au Preneur, qui accepte, l'immeuble sis au n° 14, Avenue Kenge, Quartier Mama Yemo, Commune de Ngaliema, Ville de Kinshasa, appartement ${nomAppartement}, composé de chambres, salon, salle à manger, cuisine, garde-manger et salles de bain. Le Preneur reconnaît prendre les lieux loués dans l'état où ils se trouvent et s'engage à n'en changer la destination qu'avec l'accord préalable et écrit du Bailleur.`
  )
